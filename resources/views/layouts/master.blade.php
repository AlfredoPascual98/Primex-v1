...
<head>
    ...
    <link href="{{ asset('css/bootstrap.min.dark.css') }}" rel="stylesheet" type="text/css">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <ul class="navbar-nav flex-row">
                        <li class="nav-item dropdown">
                            ...
                            <div>
                                <a href="{{route('videos.index')}}" class="btn btn-secondary my-2"> Video</a>
                                <a href="javascript: document.getElementById('logout').submit()"
                                    class="btn btn-danger my-1">Cerrar
                                    sesion</a>
